...
const SocialLogin: React.FC<SocialLoginProps> = ({ 
  ...
  const handleGoogleLogin = () => {
    ...
    try {
      ...
      onError?.(t('auth.errors.networkError'));
    }
  };
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      ...
      <button
        ...
        disabled={disabled}
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
